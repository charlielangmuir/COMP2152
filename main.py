...
weaponRoll = random.choice(weapons)
print("You rolled the" + weaponRoll)
weaponRoll = weapons.index(weaponRoll)
...
if(weaponRoll + 1 <3):
    print("You have a weak weapon")
elif(weaponRoll + 1 < 5):
    print("You have a medium weapon")
else:
    print("You rolled  astrong weapon")
if(weaponRoll>0):
    print("Good thing you didn't roll a fist")
...
print("--- Phew, you have a healing potion: " + str(
    healthPoints >= mCombatStrength or healingPotion == 1
))
